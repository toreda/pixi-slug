 ...
 */
class{constructor(textureWidth=defaults_1.Defaults.TEXTURE_SIZE){if(textureWidth<=0||textureWidth&textureWidth-1)throw new Error(`textureWidth must be a power of 2, got ${textureWidth}`);this.textureWidth=textureWidth,this.curveData=new Float32Array(0),this.bandData=new Uint32Array(0),this.glyphs=new Map,this.advances=new Map,this.unitsPerEm=0,this.ascender=0}
/**
     ...
     */async load(fontData){const font=opentype_js_1.default.parse(fontData);this.unitsPerEm=font.unitsPerEm,this.ascender=font.ascender;const glyphList=[];for(let i=0;i<font.glyphs.length;i++){const glyph=font.glyphs.get(i),charCode=glyph.unicode;if(
 ...
 */
function(text,glyphs,advances,unitsPerEm,ascender,fontSize,textureWidth,color=[1,1,1,1]){const scale=fontSize/unitsPerEm;
...
const adv=advances.get(charCode);adv&&(cursorX+=adv*scale);continue}const{bounds,hBandCount,vBandCount,bandOffset,curveOffset}=glyph,x0=cursorX+bounds.minX*scale,y0=-bounds.maxY*scale+baselineY,x1=cursorX+bounds.maxX*scale,y1=-bounds.minY*scale+baselineY,u0=bounds.minX,v0=bounds.minY,u1=bounds.maxX,v1=bounds.maxY,glyphWidth=bounds.maxX-bounds.minX,glyphHeight=bounds.maxY-bounds.minY,maxDim=Math.max(glyphWidth,glyphHeight),bandCount=Math.max(hBandCount,vBandCount),_f32=new Float32Array(4);
...
/***/},
/***/244(__unused_webpack_module,exports,__webpack_require__){"use strict";var __importDefault=this&&this.__importDefault||function(mod){return mod&&mod.__esModule?mod:{default:mod}};Object.defineProperty(exports,"__esModule",{value:!0}),exports.slugShader=
/**
 ...
 */
function(curveTexture,bandTexture,resolution){const program=core_1.Program.from(vert_glsl_1.default,frag_glsl_1.default),uniforms={uCurveTexture:curveTexture,uBandTexture:bandTexture,uResolution:new Float32Array(resolution)};return new core_1.Shader(program,uniforms)}
/***/;const core_1=__webpack_require__(780),vert_glsl_1=__importDefault(__webpack_require__(38)),frag_glsl_1=__importDefault(__webpack_require__(155))},
/***/314(__unused_webpack_module,exports,__webpack_require__){"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.SlugText=void 0;const core_1=__webpack_require__(780),display_1=__webpack_require__(492),mesh_1=__webpack_require__(564),defaults_1=__webpack_require__(195),quad_1=__webpack_require__(727),shader_1=__webpack_require__(244);
/**
 ...
 */
class SlugText extends display_1.Container{constructor(text,font,fontSize=defaults_1.Defaults.FONT_SIZE){super(),this._text=text,this._font=font,this._fontSize=fontSize,this._color=[1,1,1,1],this._mesh=null,this._curveTexture=null,this._bandTexture=null,this.rebuild()}
...
this._mesh&&(this.removeChild(this._mesh),this._mesh.destroy(),this._mesh=null),this._curveTexture?.destroy(),this._bandTexture?.destroy(),this._curveTexture=null,this._bandTexture=null,0===this._text.length||0===this._font.glyphs.size)return;
// Build per-glyph quads with all 5 vertex attributes
const quads=(0,quad_1.slugGlyphQuads)(this._text,this._font.glyphs,this._font.advances,this._font.unitsPerEm,this._font.ascender,this._fontSize,this._font.textureWidth,this._color);if(0===quads.quadCount)return;
// Create geometry with 5 interleaved vec4 attributes
const vertexBuffer=new core_1.Buffer(quads.vertices.buffer,!0),geometry=new core_1.Geometry;// 20 floats * 4 bytes per float
geometry.addAttribute("aPositionNormal",vertexBuffer,4,!1,core_1.TYPES.FLOAT,80,0),geometry.addAttribute("aTexcoord",vertexBuffer,4,!1,core_1.TYPES.FLOAT,80,16),geometry.addAttribute("aJacobian",vertexBuffer,4,!1,core_1.TYPES.FLOAT,80,32),geometry.addAttribute("aBanding",vertexBuffer,4,!1,core_1.TYPES.FLOAT,80,48),geometry.addAttribute("aColor",vertexBuffer,4,!1,core_1.TYPES.FLOAT,80,64);
...
const indices16=new Uint16Array(quads.indices.length);for(let i=0;i<quads.indices.length;i++)indices16[i]=quads.indices[i];geometry.addIndex(indices16);
// Curve texture: RGBA float32
const textureWidth=this._font.textureWidth,curveRows=Math.ceil(this._font.curveData.length/4/textureWidth)||1,curveBase=core_1.BaseTexture.fromBuffer(this._font.curveData,textureWidth,curveRows,{format:core_1.FORMATS.RGBA,type:core_1.TYPES.FLOAT});this._curveTexture=new core_1.Texture(curveBase);
...
const bandRows=Math.ceil(this._font.bandData.length/4/textureWidth)||1,bandFloat=new Float32Array(this._font.bandData.length);for(let i=0;i<this._font.bandData.length;i++)bandFloat[i]=this._font.bandData[i];const bandBase=core_1.BaseTexture.fromBuffer(bandFloat,textureWidth,bandRows,{format:core_1.FORMATS.RGBA,type:core_1.TYPES.FLOAT});this._bandTexture=new core_1.Texture(bandBase);
...
/******/return(()=>{"use strict";var exports=__webpack_exports__;Object.defineProperty(exports,"__esModule",{value:!0}),exports.slugShader=exports.SlugText=exports.SlugFont=void 0;var font_1=__webpack_require__(330);Object.defineProperty(exports,"SlugFont",{enumerable:!0,get:function(){return font_1.SlugFont}});var text_1=__webpack_require__(314);Object.defineProperty(exports,"SlugText",{enumerable:!0,get:function(){return text_1.SlugText}});var shader_1=__webpack_require__(244);Object.defineProperty(exports,"slugShader",{enumerable:!0,get:function(){return shader_1.slugShader}})})(),__webpack_exports__;
/******/})());