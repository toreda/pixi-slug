!function(root,factory){"object"==typeof exports&&"object"==typeof module?module.exports=factory(require("@pixi/display"),require("@pixi/core")):"function"==typeof define&&define.amd?define([,],factory):"object"==typeof exports?exports.pixiSlug=factory(require("@pixi/display"),require("@pixi/core")):root.pixiSlug=factory(root.PIXI,root.PIXI)}(this,(__WEBPACK_EXTERNAL_MODULE__492__,__WEBPACK_EXTERNAL_MODULE__780__)=>/******/(()=>{// webpackBootstrap
 ...
 */
function(font,curveTexture,bandTexture){const program=core_1.Program.from(vert_glsl_1.default,frag_glsl_1.default),uniforms={uSlugMatrix:new Float32Array(16),uSlugViewport:new Float32Array(2),uLogTextureWidth:Math.log2(font.textureWidth),uCurveTexture:curveTexture,uBandTexture:bandTexture};return new core_1.Shader(program,uniforms)}
/***/;const core_1=__webpack_require__(780),vert_glsl_1=__importDefault(__webpack_require__(972)),frag_glsl_1=__importDefault(__webpack_require__(155))},
/***/241(__unused_webpack_module,exports,__webpack_require__){"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.SlugText=void 0;const display_1=__webpack_require__(492);
/**
 ...
 */class SlugText extends display_1.Container{constructor(text,font){super(),this._text=text,this._font=font,this._mesh=null,this._curveTexture=null,this._bandTexture=null}
...
}destroy(){this._mesh?.destroy(),this._curveTexture?.destroy(),this._bandTexture?.destroy(),super.destroy()}}exports.SlugText=SlugText},
