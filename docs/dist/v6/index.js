...
/***/},
/***/827(__unused_webpack_module,exports,__webpack_require__){"use strict";var __importDefault=this&&this.__importDefault||function(mod){return mod&&mod.__esModule?mod:{default:mod}};Object.defineProperty(exports,"__esModule",{value:!0}),exports.slugShader=
/**
 ...
 */
function(curveTexture,bandTexture,resolution){const program=core_1.Program.from(vert_glsl_1.default,frag_glsl_1.default),uniforms={uCurveTexture:curveTexture,uBandTexture:bandTexture,uResolution:new Float32Array(resolution),uSupersampleCount:0};return new core_1.Shader(program,uniforms)}
...
/***/241(__unused_webpack_module,exports,__webpack_require__){"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.SlugText=void 0;const core_1=__webpack_require__(780),display_1=__webpack_require__(492),mesh_1=__webpack_require__(564),defaults_1=__webpack_require__(195),quad_1=__webpack_require__(727),shader_1=__webpack_require__(827);
/**
 ...
 */
class SlugText extends display_1.Container{constructor(text,font,fontSize=defaults_1.Defaults.FONT_SIZE){super(),this._text=text,this._font=font,this._fontSize=fontSize,this._color=[1,1,1,1],this._mesh=null,this._curveTexture=null,this._bandTexture=null,this._supersampling=!1,this._supersampleCount=defaults_1.Defaults.SUPERSAMPLE_COUNT,this._shader=null,this._vertexBytes=0,this._indexBytes=0,this._rebuildCount=0,this.rebuild()}
...
/** Enable supersampling for smoother edges. */get supersampling(){return this._supersampling}set supersampling(value){this._supersampling!==value&&(this._supersampling=value,this._shader&&(this._shader.uniforms.uSupersampleCount=value?this._supersampleCount:0))}
/** Number of supersamples (2, 4, 8, or 16). Only used when supersampling is true. */get supersampleCount(){return this._supersampleCount}set supersampleCount(value){const clamped=Math.min(Math.max(value,1),defaults_1.Defaults.MAX_SUPERSAMPLE_COUNT);this._supersampleCount!==clamped&&(this._supersampleCount=clamped,this._shader&&this._supersampling&&(this._shader.uniforms.uSupersampleCount=clamped))}
/**
...
const shader=(0,shader_1.slugShader)(this._curveTexture,this._bandTexture,[800,400]);this._shader=shader,shader.uniforms.uSupersampleCount=this._supersampling?this._supersampleCount:0,this._mesh=new mesh_1.Mesh(geometry,shader),this.addChild(this._mesh)}
...
/******/return(()=>{"use strict";var exports=__webpack_exports__;Object.defineProperty(exports,"__esModule",{value:!0}),exports.slugShader=exports.SlugText=exports.SlugFont=void 0;var font_1=__webpack_require__(330);Object.defineProperty(exports,"SlugFont",{enumerable:!0,get:function(){return font_1.SlugFont}});var text_1=__webpack_require__(241);Object.defineProperty(exports,"SlugText",{enumerable:!0,get:function(){return text_1.SlugText}});var shader_1=__webpack_require__(827);Object.defineProperty(exports,"slugShader",{enumerable:!0,get:function(){return shader_1.slugShader}})})(),__webpack_exports__;
/******/})());