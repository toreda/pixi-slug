 ...
 */
function(curveTexture,bandTexture){const glProgram=pixi_js_1.GlProgram.from({vertex:vert_glsl_1.default,fragment:frag_glsl_1.default}),uniforms=new pixi_js_1.UniformGroup({uSupersampling:{value:0,type:"i32"}});
...
/** Enable 4-sample rotated-grid supersampling for smoother edges. */get supersampling(){return this._supersampling}set supersampling(value){this._supersampling!==value&&(this._supersampling=value,this._uniforms&&(this._uniforms.uniforms.uSupersampling=value?1:0))}
/**
