 ...
 */
function(font){if(font.gpuCache)return font.gpuCache;const textureWidth=font.textureWidth,curveRows=Math.ceil(font.curveData.length/4/textureWidth)||1,curveTexture=new pixi_js_1.Texture({source:new pixi_js_1.BufferImageSource({resource:font.curveData,width:textureWidth,height:curveRows,format:"rgba32float",autoGenerateMipmaps:!1,scaleMode:"nearest",alphaMode:"no-premultiply-alpha"})}),bandRows=Math.ceil(font.bandDataFloat32.length/4/textureWidth)||1,bandTexture=new pixi_js_1.Texture({source:new pixi_js_1.BufferImageSource({resource:font.bandDataFloat32,width:textureWidth,height:bandRows,format:"rgba32float",autoGenerateMipmaps:!1,scaleMode:"nearest",alphaMode:"no-premultiply-alpha"})}),glProgram=pixi_js_1.GlProgram.from({vertex:vert_glsl_1.default,fragment:frag_glsl_1.default}),cache={curveTexture,bandTexture,glProgram};
