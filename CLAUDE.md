...
- **[_docs/artifact_investigation.md](_docs/artifact_investigation.md)** - Sharp-angle vertex artifact investigation (V/X/R/W — RESOLVED 2026-03-19)
  *Root cause analysis, all 8 fix attempts with results, debug data from V glyph. Two bugs fixed: vertical solver sign and CalcCoverage min→max.*
