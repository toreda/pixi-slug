...
// PixiJS v6 variant: uses v6 uniform names (identical
// to v7's by convention — kept as an isolated copy so
// v6 and v7 can diverge without coupling).
// ===================================================
...
// Viewport size must be provided manually in v6 (no built-in uResolution).
